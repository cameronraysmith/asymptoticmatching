...
\end{align*}
where, in the second line of the derivation, we use the fact that $e^{Ht} \ket{0, 0} = \ket{0, 0}$ which follows from expanding the exponential and noting that $H \ket{0, 0} = 0$.  We can obtain $a^\dagger (t)$ from the formulae
\begin{align*}
 ...
 e^{ht} \begin{pmatrix} b \\ a \end{pmatrix} \end{align*}.
